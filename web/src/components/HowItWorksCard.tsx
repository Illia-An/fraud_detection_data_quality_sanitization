    ...
    <Accordion disableGutters sx={{ mb: 2, '&:before': { display: 'none' } }}>
      ...
      <AccordionDetails sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
        ...
        <Typography component="ul" sx={{ m: 0, pl: 2.5 }}>
          <li>
            <strong>Tier 1</strong> — BlackList filter (keep regular customers only).
          </li>
          <li>
            <strong>Tier 2</strong> — high frequency: same person, same store, same day.
          </li>
          <li>
            <strong>Tier 3</strong> — optional always top-box (100% fives with enough history).
          </li>
          <li>
            <strong>Tier 4</strong> — store×month cells with unusually high scores vs the network.
          </li>
        </Typography>
        <Typography variant="body1">
          On start the tool loads <strong>Q10012 from 2026-01-01 through latest</strong> and
          runs all enabled tiers. If the database is unavailable, it falls back to a{' '}
